      ...
      <div className="w-full max-w-sm px-4">
        <div className="flex flex-col items-center mb-8">
          <div
            ...
            style={{ background: "linear-gradient(135deg, var(--color-accent), var(--color-text-secondary))", borderRadius: "16px", width: "52px", height: "52px" }}
          >
        ...
        {done ? (
          <div className="glass-card p-6 flex flex-col items-center gap-3" style={{ borderColor: "rgba(52,211,153,0.3)" }}>
            ...
            <p className="text-sm" style={{ color: "var(--color-muted)" }}>Taking you to the dashboard…</p>
          </div>
        ) : (
